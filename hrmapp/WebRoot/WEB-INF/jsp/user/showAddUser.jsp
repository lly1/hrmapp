	...
	$(function(){
		...
		$("#userForm").submit(function(){
			...
			if ($.trim(username.val()) == ""){
				...
				msg = "状态不能为空！";
				status.focus();
			}else if (isNaN($.trim(status.val())) || $.trim(status.val()) >11 || $.trim(status.val()) <0){
			    msg = "请输入0-11的数！";
			    status.focus();
    ...
    <td>
    	 <form action="${ctx}/user/addUser" id="userForm" method="post">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<tr><td align="left" class="fftd"><input type="submit" value="添加">&nbsp;&nbsp;<input type="reset" value="取消 " onclick="javascript:location.href='${ctx}/user/selectUser'"></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
